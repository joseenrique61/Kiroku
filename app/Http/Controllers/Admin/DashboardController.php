...
{
    public function __construct(protected PredictiveAnalyticServiceInterface $predictive_analytic, protected FailureAnalyticServiceInterface $failure_analytic, protected MaintenanceAnalyticServiceInterface $maintenance_analytic, protected DeviceAnalyticServiceInterface $device_analytic, protected DeviceServiceInterface $device_service)
    {
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('admin/dashboard', [
            ...
            'deviceCategories' => $this->device_service->getAllDeviceCategories()
        ]);
    }
}